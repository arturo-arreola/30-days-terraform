...
resource "aws_vpc" "primary_vpc" {
  ...
  tags = {
    Name        = "primary_vpc_${var.primary_region}"
    Environment = "Demo"
  }
}
...
resource "aws_vpc" "secondary_vpc" {
  ...
  tags = {
    Name        = "secondary_vpc_${var.secondary_region}"
    Environment = "Demo"
  }
}
...
resource "aws_subnet" "primary_subnet" {
  ...
  tags = {
    Name        = "primary_subnet_${var.primary_region}"
    Environment = "Demo"
  }
}
...
resource "aws_subnet" "secondary_subnet" {
  ...
  tags = {
    Name        = "secondary_subnet_${var.secondary_region}"
    Environment = "Demo"
  }
}
...
resource "aws_internet_gateway" "primary_igw" {
  ...
  tags = {
    Name        = "primary_igw_${var.primary_region}"
    Environment = "Demo"
  }
}
...
resource "aws_internet_gateway" "secondary_igw" {
  ...
  tags = {
    Name        = "secondary_igw_${var.secondary_region}"
    Environment = "Demo"
  }
}
...
resource "aws_route_table" "primary_route_table" {
  ...
  tags = {
    Name        = "primary_route_table_${var.primary_region}"
    Environment = "Demo"
  }
}
...
resource "aws_route_table" "secondary_route_table" {
  ...
  tags = {
    Name        = "secondary_route_table_${var.secondary_region}"
    Environment = "Demo"
  }
}
...
resource "aws_vpc_peering_connection" "vpc_peering_primary_secondary" {
  provider    = aws.primary
  vpc_id      = aws_vpc.primary_vpc.id
...
resource "aws_vpc_peering_connection_accepter" "secondary_accepter" {
  provider                  = aws.secondary
  vpc_peering_connection_id = aws_vpc_peering_connection.vpc_peering_primary_secondary.id
  auto_accept               = true
...
# Route from Primary VPC to Secondary VPC
